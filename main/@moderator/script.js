...
${r.message}`,
    ...
    const Gj = {
        ...
        o4 = {
            UNSUPPORTED_BROWSER: "このブラウザではこのゲームが遊べない。 View '?' or HELP to see a list of compatible browsers.",
            ROOM_IS_FULL: "そのロビーは満員",
            ROOM_NOT_FOUND: "そのルームは見つからない",
            AUDIENCE_IS_FULL: "観客席は満員",
            UNABLE_TO_CONNECT: "Jackbox Gamesのサーバーにつながってられない。おそらく、広告ブロック拡張機能かなにかが問題を起こしている",
            UNABLE_TO_PRELOAD: "Unable to preload this game bundle",
            KICKED: "管理人によって追い出されているために、このゲームには参加できない",
            REQUIRES_TWITCH_LOGIN: "参加するにはTwitch認証が必要",
            ROOM_IS_LOCKED: "そのゲームはパスワード制限されている",
            INCORRECT_PASSWORD: "パスワードは間違っている",
            GENERIC: "そのゲームには参加できなかった",
            FILTER_NAME: "そのゲームは一般向けモード有効です。別のロビーを探していい"
        },
        c4 = {
            NAME: "なまえ",
            NAME_PLACEHOLDER: "漢字はお手柔らかに",
            PASSWORD_PLACEHOLDER: "５桁の数字列",
            PASSWORD_REQUIRED_TITLE: "パスワードが必要",
            PASSWORD_REQUIRED_BODY: "パスワードをインプットor観客として参加",
            PASSWORD_JOIN_AS_PLAYER: "参加者になる",
            PASSWORD_JOIN_AS_AUDIENCE: "観客になる",
            ROOM_CODE: "コード",
            ROOM_CODE_PLACEHOLDER: "４文字の番号部屋"
        },
